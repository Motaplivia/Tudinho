 ...
 * SplashScreen.tsx
 * 
 * Tela inicial do aplicativo que é exibida durante o carregamento.
 * Funcionalidades:
 * - Animação de entrada com fade e escala
 * - Exibição do logo e nome do aplicativo
 * - Navegação automática para a tela de login
 * - Interface minimalista e atraente
 */
